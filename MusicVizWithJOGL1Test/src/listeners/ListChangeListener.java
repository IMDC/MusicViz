...
public class ListChangeListener implements ListSelectionListener
{
	...
	public void valueChanged(ListSelectionEvent e) 
	{
		...
		Song currentSong = player.currentSongPlaying();//controller.getCurrentSongPlaying();
		Song tempSong;
		...
		{				
			...
			//the  song variable in the player to correspond this change.
      	    ...
      	    {
      	    	player.currentSongPlaying().setIndex(i);//controller.getCurrentSongPlaying().setIndex(i);
      	    }
      	    tempSong.setIndex(i);
		}
		...
		{
			//disables the slider 
			gui.disableSlider();//controller.disableSlider();
			gui.setCurrentValueForSlider(0);//controller.setCurrentValueForSlider(0);
