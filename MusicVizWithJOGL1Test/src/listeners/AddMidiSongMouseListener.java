...
public class AddMidiSongMouseListener implements MouseListener
{
	...
	public void mouseReleased(MouseEvent event)
	{
        ...
        if( song != null )
        {
        	listModel = (DefaultListModel) gui.getPlaylist().getModel();//controller.getPlaylist().getModel();
	        ...
	        if( listModel.getSize() == 0 )
	        {
	        	...
	        	isPlayable= player.openMidiFile(song, false);//controller.startPreprocessing(song,false);
	        }
	        else
	        {
