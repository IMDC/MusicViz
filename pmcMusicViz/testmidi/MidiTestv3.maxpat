{
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "js minMaxChan.js",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"id" : "obj-51",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 689.0, 174.0, 105.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-50",
					"fontsize" : 12.0,
					"patching_rect" : [ 535.0, 151.0, 61.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-48",
					"fontsize" : 12.0,
					"patching_rect" : [ 624.0, 202.0, 50.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 606.0, 121.0, 89.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 578.0, 85.0, 65.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 528.0, 18.0, 41.0, 18.0 ],
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "", "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 386.0, 72.0, 122.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 472.0, 18.0, 33.0, 18.0 ],
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 424.0, 19.0, 43.0, 18.0 ],
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 381.0, 18.0, 35.0, 18.0 ],
					"numinlets" : 2
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-4", 1 ],
					"hidden" : 0,
					"midpoints" : [ 433.5, 51.0, 119.5, 51.0 ]
				}
