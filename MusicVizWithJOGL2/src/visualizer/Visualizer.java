...
{	
	...
	{	
	    ...
	    if( controller.isRunning() && partsMapped != null  )
		{
	    	...
	    	gl.glNewList(theList, GL2.GL_COMPILE);
				for(String s : partsMapped.keySet() )
				{
	...
	public void init(GLAutoDrawable drawable)
	{
	    ...
	    gl.glMaterialfv(GL.GL_FRONT_AND_BACK, GL2.GL_EMISSION, emissiveMaterial, 0);
	    gl.glMaterialfv(GL.GL_FRONT, GL2.GL_SPECULAR, mat_specular, 0);
	    gl.glMaterialf(GL.GL_FRONT, GL2.GL_SHININESS, 90.0f);
    	...
    	gl.glNewList(beatList[0], GL2.GL_COMPILE);
    	...
    	gl.glNewList(beatList[1], GL2.GL_COMPILE);
    	...
    	gl.glNewList(beatList[2], GL2.GL_COMPILE);
			qobj = glu.gluNewQuadric();
    	...
    	gl.glNewList(beatList[3], GL2.GL_COMPILE);
			qobj = glu.gluNewQuadric();
    	...
    	gl.glNewList(beatList[4], GL2.GL_COMPILE);
			qobj = glu.gluNewQuadric();
