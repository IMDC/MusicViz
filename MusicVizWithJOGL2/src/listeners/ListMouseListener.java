...
public class ListMouseListener implements MouseListener
{
	...
	public void mouseReleased(MouseEvent event)
	{
		if( event.getClickCount() == 2 && event.getButton() == 1 && firstIndex != -1)
		{
			...
			int i =   controller.getCurrentSongPlaying().getIndex();
			...
			controller.startPreprocessing(song,true);
			//controller.play();
			
			//Now i have to make the JToggleButton toggle to show this change.
			controller.getPlayPauseToggleButton().setSelected(true);
			controller.getPlayPauseToggleButton().setText("Pause");
		}	
		list.repaint();
	}
