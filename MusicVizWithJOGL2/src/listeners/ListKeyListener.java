	...
	public void keyPressed(KeyEvent event) 
	{
		...
		{			
			...
			{				
				...
				if( listModel.getSize() >= 1 && tempName.equalsIgnoreCase(controller.getCurrentSongPlaying().getName()) )
				{
					controller.stop();
					...
					controller.startPreprocessing(song,false);
				}
				else if( listModel.getSize() == 0)
				{
					controller.stop();
					controller.updateTotalTime("0:00");
