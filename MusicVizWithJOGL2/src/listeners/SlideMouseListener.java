...
public class SlideMouseListener implements MouseListener, MouseMotionListener
{
	...
	public void mousePressed(MouseEvent e)
	{
		...
		if( ((DefaultListModel) controller.getPlaylist().getModel()).getSize() != 0 )
		{
	...
	{	
		...
		controller.changeSongPosition( slider.getValue() );
		...
		long currentTick = controller.getCurrentTickPositionOfSong();
