...
public class ConcurrentPipe 
{
	 ...
	 */
	public ConcurrentPipe( int channel, int pipe, int amountOfSections, float[] color, float[] translations )
	{
	 ...
	 */
	public ConcurrentLinkedQueue<float[][]> getPositionAnimationList()
	{
	 ...
	 */
	public ConcurrentLinkedQueue<Float> getAlphaAnimationList()
	{
